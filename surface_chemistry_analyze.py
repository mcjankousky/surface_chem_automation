...
parser.add_argument('--pressure_range', type=float, default=[0,10], nargs=2,metavar=('pressure_low', 'pressure_high'),
                    help='Range of pressures for phase diagram plots in atmospheres. Defaults to 0-10.')
parser.add_argument('--temperature_range', type=float, default=[0,500], nargs=2,metavar=('temp_low', 'temp_high'),
                    help='Range of temperatures for phase diagram plots in Kelvin. Defaults to 0-500.')
...
E_df = E_conv_collect.E_conv_collect(chem_dir,'surface_chemistry')
